 ...
 * Git version: unknown
 * Options:   --output /home/shabivps/source/repo/clang-learning/generated-programs/18.c
 * Seed:      2783362324
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4[3] = {0xA9C4C8D3L,0xA9C4C8D3L,0xA9C4C8D3L};
...
static uint16_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_3[10] = {&g_4[2],(void*)0,&g_4[2],(void*)0,&g_4[2],(void*)0,&g_4[2],(void*)0,&g_4[2],(void*)0};
    int32_t **l_2 = &l_3[8];
    int32_t *l_6 = &g_4[1];
    int32_t **l_5 = &l_6;
    int i;
    (*l_5) = ((*l_2) = (void*)0);
    g_4[1] = (safe_rshift_func_int8_t_s_s(g_4[2], (g_4[0] || g_4[1])));
    return g_4[1];
}
