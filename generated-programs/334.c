 ...
 * Git version: unknown
 * Options:   --output /home/shabivps/source/repo/clang-learning/generated-programs/334.c
 * Seed:      1323338516
 */
...
static volatile int32_t g_4 = 0xDA8E97EEL;/* VOLATILE GLOBAL g_4 */
...
/* ------------------------------------------ */
/* 
 * reads : g_5 g_6 g_7 g_4
 * writes: g_5 g_7
 */
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_2[10] = {0xC0L,0xC0L,0xC0L,0xC0L,0xC0L,0xC0L,0xC0L,0xC0L,0xC0L,0xC0L};
    ...
    { /* block id: 3 */
        ...
        int32_t *l_13 = (void*)0;
        int32_t *l_14 = &l_12;
        int32_t *l_15[6] = {(void*)0,(void*)0,&g_5,(void*)0,(void*)0,&g_5};
        int i;
        (*g_6) |= l_2[g_5];
        l_12 ^= ((g_7 , (((l_2[g_5] != ((((l_2[7] > (safe_unary_minus_func_int32_t_s((*g_6)))) == (g_7 == g_7)) & (!(l_10 != l_10))) < (((l_11 == &g_7) & (*l_10)) < (*l_10)))) , g_4) , 0xB43D2717L)) > g_7);
        l_16++;
        (*l_10) = 0x193FE696L;
    }
    return (*l_11);
